        ...
        <div className="flex gap-[48px]">
          <div className="h-[504px] w-[350px] flex flex-col gap-[20px]">
            <div className="h-[180px] w-full">
              <img src={Fintech2} alt="Case Study 1" className="h-full" />
            </div>
            <div className="flex flex-col gap-[18px] items-center">
              ...
              >
                A high-volume transaction provider implemented ISO 27001 to
                secure international transactions, reduce breaches, and ensure
                regulatory compliance, gaining ISO 27001 certification.
              </Text>
