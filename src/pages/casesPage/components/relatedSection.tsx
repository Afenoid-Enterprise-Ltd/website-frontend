...
const RelatedSection: React.FC<RelatedSectionProps> = ({ relatedCases }) => {
  ...
  return (
    <section className="px-[5rem] msm:px-[3rem] msm:w-full mxs:px-[2rem]">
      <div className="bg-[#EBEEEB] mx-auto py-[50px] flex flex-col items-center gap-[48px] w-full msm:px-4">
        <div className="w-[70%] px-3 mxs:w-[90%]">
              ...
              {isSmallDevice ? (
                <Slider {...settings}>
                  {relatedCases?.map((relatedCase: RelatedCases) => {
                    return (
                      <div className="h-[504px] w-[400px] flex flex-col gap-5 msm:w-full msm:h-fit msm:mb-3">
